...
edad = int(input())
print('Altura en cm')
# en mts, usaria variable float para en ingreso del dato
altura = int(input())

print('Su nombre completo es', nombre.capitalize()+ ' '+ apellido.capitalize(), ', DNI:', dni)

print('Nombre completo:', nombre.capitalize()+ ' '+ apellido.capitalize(), '; edad:', edad, '; altura:', altura, 'cm.')
